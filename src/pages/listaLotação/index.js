...
export default function Listalotacao(){
    ...
    function mostrarlista(){
        ...
        let listaUsuarios=JSON.parse(localStorage.getItem("cad-usuarios")||"[]");
        setUsuario(listaUsuarios);      
        let listaEmpresas=JSON.parse(localStorage.getItem("cad-empresa")||"[]");
        setEmpresa(listaEmpresas);      
        let listaSetor=JSON.parse(localStorage.getItem("cad-setor")||"[]");
        setSetor(listaSetor);      
        let listaPatrimonio=JSON.parse(localStorage.getItem("cad-patrimonio")||"[]");
        setPatrimonio(listaPatrimonio);   
        let listalotacao=JSON.parse(localStorage.getItem("cad-lotacao")||"[]");
